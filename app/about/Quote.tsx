        ...
        {expanded ? (
          <>
            <Text>
              ...
              applications, servers and back-end software. I speak English, Russian and Arabic as a native speaker, I'm
              a medical student at The Egyption Assiut National University.
            </Text>
            <Text>
              With a self-taught foundation in [programming languages, frameworks, or technologies], I've honed my
            ...
            <Text>
              ...
              medcine as a student-doctor, exploring open-source projects. I'm always eager to collaborate with
          ...
          <>
            <Text>
              I'm Ibrahim M. A. Megahed, a multi-passion person with medicine knowledge and software developing
              innovative skills. I've been in the tech industry since 2019, working on web applications, servers, and
              back-end software. I speak English, Russian, and Arabic as a native speaker, and I'm a medical student at
              The Egyption Assiut National University. I build software for myself, friends, or education, when I'm not
              learning medicine. I'm always eager to collaborate with like-minded individuals who share my passion for
              tech and innovation. Feel free to reach out if you'd like to chat about a project idea or get feedback on
              my/your code, or simply grab a coffee and discuss the latest tech trends!
            </Text>
          </>
        )}
      </Stack>
